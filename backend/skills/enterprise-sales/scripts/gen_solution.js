...
// 指定全局 node_modules 路径，确保 docx 包可访问
process.env.NODE_PATH = "/Users/wrg/.nvm/versions/node/v24.16.0/lib/node_modules";
  ...
  sections: [
    {
      ...
      headers: {
        default: new Header({
          children: [new Paragraph({
            ...
            children: [new TextRun({ text: "浙江联通 · 客户解决方案", font: "Arial", size: 18, color: "999999" })],
          })],
        }),
      },
      footers: {
      ...
      children: [
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          spacing: { after: 100 },
          children: [new TextRun({ text: "浙江联通 · 客户解决方案", bold: true, size: 44, color: "1E4073" })],
        }),
        // ---- 副标题 ----
        new Paragraph({
          alignment: AlignmentType.CENTER,
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          children: [new TextRun({ text: "— 本方案由浙江联通客户经理自动生成，仅供参考 —", size: 18, color: "AAAAAA", italics: true })],
        }),
      ],
    },
  ],
